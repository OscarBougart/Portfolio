  ...
  return (
    <div className="container  ">
      ...
      <MouseParallax strength={0.05} parallaxContainerRef={parallaxRef}>
        ...
        <div className="absolute fill-ls-flower  left-[-30%] bottom-40 origin-bottom rotate-[54deg]">
          <svg
            className="w-52 h-52 opacity-40"
            viewBox="0 0 32.00 32.00"
            version="1.1"
        ...
        <div className="absolute fill-ls-flower  left-[50%] origin-bottom rotate-[54deg]">
          <svg
            className="w-52 h-52 opacity-40"
            viewBox="0 0 32.00 32.00"
            version="1.1"
